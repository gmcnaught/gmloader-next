...
int main(int argc, char **argv) {
    ...
    blt_vtx_t tris[3] = {
        { (int16_t)(160 << 4), (int16_t)(10  << 4), (uint16_t)(64 << 4), (uint16_t)(0   << 4), BLT_RGBA(255, 255, 255, 255), 0 },
        { (int16_t)(315 << 4), (int16_t)(220 << 4), (uint16_t)(127 << 4), (uint16_t)(127 << 4), BLT_RGBA(255, 255, 255, 255), 0 },
        { (int16_t)(5   << 4), (int16_t)(220 << 4), (uint16_t)(0 << 4),  (uint16_t)(127 << 4), BLT_RGBA(255, 255, 255, 255), 0 },
    };
